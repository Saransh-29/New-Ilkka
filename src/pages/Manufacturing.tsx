...
export default function Manufacturing() {
  ...
  const units = [
    ...
    { id: 'IV', name: 'Quality Assurance', loc: 'Delhi', cap: 'Batch release & documentation', cert: 'Safety, efficacy, reliability', desc: 'End-to-end quality oversight from raw material sampling through finished goods release — every batch cleared to the highest regulatory standards.' },
  ];
